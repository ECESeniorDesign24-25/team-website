...
const Home: React.FC<NavigationProps<'Home'>> = ({ navigation }) => {
  ...
  const projects = [
    ...
    { name: 'ESP Digital Filter', image1: require('../../Lab2.jpg'), image2: require('../../Lab2.jpg'), reportFile: '/assets/Lab2DigitalFilter.pdf', description: 'Our ESP Digital Filter project utilized an ESP32 Microcontroller and custom circuitry to implement a digital filter.'},
  ]
