...
const Home: React.FC<NavigationProps<'Home'>> = ({ navigation }) => {
  ...
  const members = [
    ...
    { name: 'Holland', image1: require('../../Holland1.jpg'), image2: require("../../Holland2.jpg"), bio: "Holland is a fourth-year Electrical Engineering student with a focus in Power Systems. Upon graduating he intends to pursue work in transmission and distribution planning, substation design and/or protective relay design.", email: "holland-gilmore@uiowa.edu"},
