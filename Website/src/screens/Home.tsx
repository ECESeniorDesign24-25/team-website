...
const Home: React.FC<NavigationProps<'Home'>> = ({ navigation }) => {
  ...
  const members = [
    ...
    { name: 'Cavan', image1: require('../../assets/cavan_profile_image.png'), image2: require("../../assets/cavan_profile_image.png"), bio: "To be determined.", email: "cavan-riley@uiowa.edu" },
  ];
