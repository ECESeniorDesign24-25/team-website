...
const Home: React.FC<NavigationProps<'Home'>> = ({ navigation }) => {
  ...
  const members = [
    ...
    { name: 'Holland', image1: require('../../joseph_headshot.jpeg'), image2: require("../../BriPic2.jpg"), bio: "Holland is a fourth-year Electrical Engineering student with a focus in Power Systems. Upon graduating he intends to pursue work in transmission and distribution planning, substation design and/or protective relay design.", email: "holland-gilmore@uiowa.edu"},
  ...
  const projects = [
    { name: 'Smart Thermostat', image: require('../../joseph_headshot.jpeg'), reportFile: '/assets/Lab1SmartThermostat.pdf'},
    { name: 'ESP Digital Filter', image: require('../../joseph_headshot.jpeg'), reportFile: '/assets/Lab2DigitalFilter.pdf'},
  ];
