...
const HomePage: React.FC<NavigationProps<"Home">> = ({ navigation }) => {
  ...
  const members = [
    {
      name: "Joseph",
      image1: require("../../joseph_headshot.jpeg"),
      image2: require("../../joseph_pic_2.jpg"),
      bio: "Joseph is a fourth-year Computer Science and Engineering student with a focus on Machine Learning. He is from Ankeny, Iowa. Joseph currently works at John Deere for their Intelligent Solutions Group focusing on software development and automation. Outside of school, he enjoys playing soccer, basketball, and poker.",
      email: "jbkrueger@uiowa.edu",
      number: "+16087974248",
    },
    {
      name: "Holland",
      image1: require("../../Holland1.jpg"),
      image2: require("../../Holland1.jpg"),
    ...
    {
      name: "Bri",
      image1: require("../../BriPic1.jpg"),
      image2: require("../../BriPic2.jpg"),
      bio: "Bri is a fourth-year Electrical Engineering student with a focus on sustainability. She grew up in West Liberty, Iowa, a community with a majority Hispanic population. Upon graduation, Bri plans to move out of state to pursue a career in embedded systems and/or energy consumption. She is committed to prioritizing travel, expanding her knowledge, and engaging in outreach efforts to support STEM education in lower-income Hispanic communities.",
      email: "brianna-villarreal@uiowa.edu",
      number: "+16087974248",
    },
    {
      name: "Cavan",
  ...
  const projects = [
    {
      ...
      reportFile: "/assets/Lab1SmartThermostat.pdf",
      description:
    ...
    },
    {
      ...
      reportFile: "/assets/Lab2DigitalFilter.pdf",
      description:
  ...
  return (
    ...
    >
      {/* Header */}
      <Text style={[commonStyle.header, { color: darkTheme.accentYellow }]}>
        ECE Team 15: GymHawks
      </Text>

      {/* Members */}
      <Text
        style={[commonStyle.sectionTitle, { color: darkTheme.accentYellow }]}
      >
        Members
      </Text>
      <View style={commonStyle.row}>
        {members.map((member, index) => (
          <View key={index} style={commonStyle.memberContainer}>
            ...
            <TouchableOpacity
              style={[
                commonStyle.memberButton,
                { backgroundColor: darkTheme.cardBlack },
              ]}
              onPress={() =>
                handleNavigationRequest("MemberPage", {
                  name: member.name,
                  image: member.image2,
                  bio: member.bio,
                  email: member.email,
            ...
            >
              <Text
                style={[commonStyle.nameText, { color: darkTheme.textWhite }]}
              >
                {member.name}
              </Text>
            </TouchableOpacity>
      ...
      <View style={commonStyle.row}>
        {projects.map((project, index) => (
          <View key={index} style={commonStyle.memberContainer}>
            ...
            <TouchableOpacity
              style={[
                commonStyle.projectButton,
                { backgroundColor: darkTheme.cardBlack },
              ]}
              onPress={() =>
                handleNavigationRequest("ProjectPage", {
                  name: project.name,
